...
class Widget:
    def __init__(
            ...
            config: Config,
            draw_func:
            typing.Callable[[Widget], None] |
            typing.Callable[[Widget, dict[str, typing.Any]], None] |
            typing.Callable[[Widget, list[str]], None],
            interval: int | float | None,
            dimensions: Dimensions,
            stdscr: typing.Any,
            update_func: typing.Callable[[Widget], dict[str, typing.Any] | list[str]] | None = None
    ) -> None:
        self.name: str = name
        self.title: str = title
        self.config: Config = config
        self.interval: int | float | None = interval
        self._update_func: typing.Callable[[Widget], dict[str, typing.Any] | list[str]] | None = update_func
        self._draw_func: \
            typing.Callable[[Widget], None] |\
            typing.Callable[[Widget, dict[str, typing.Any]], None] |\
            typing.Callable[[Widget, list[str]], None]\
...
class RestartException(Exception):
    pass  # Raised to signal that the curses UI should restart
...
def init_colors() -> None:
    global CUSTOM_BACKGROUND_NUMBER
